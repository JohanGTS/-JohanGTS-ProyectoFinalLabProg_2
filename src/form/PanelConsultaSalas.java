...
public class PanelConsultaSalas extends javax.swing.JPanel {
    ...
    private void ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultarActionPerformed
        Tabla.setRowCount(0);
        String IDSalas, NombreSalas, DescripcionSalas,IDLocalizacionSalas;
        File arch= new File("C:\\-JohanGTS-ProyectoFinalLabProg_2\\src\\ArchivosDeTexto\\archivoSalas.txt");
        ...
        try
        {
            if(arch.exists())
            {
                ...
                while (s.hasNextLine())
                {
                    ...
                    IDSalas=k.next();
                    NombreSalas=k.next();
                    DescripcionSalas=k.next();
                    IDLocalizacionSalas=k.next();
                    Tabla.addRow(new Object [] {IDSalas,NombreSalas,DescripcionSalas,IDLocalizacionSalas});
